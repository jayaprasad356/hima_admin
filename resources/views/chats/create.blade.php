...
@section('title', 'Create Chats')
@section('content-header', 'Create Chats')
            ...
            <form action="{{ route('chats.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <button type="button" class="btn btn-primary" onclick="toggleUserListModal()">Select User</button>
                 ...
                 <div class="form-group"><br>
                    ...
                    <textarea name="latest_message" class="form-control @error('latest_message') is-invalid @enderror" id="latest_message" rows="3" placeholder="Latest Message">{{ old('latest_message') }}</textarea>
