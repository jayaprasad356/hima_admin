...
@section('content-header', 'Wallet Management')
...
<div class="card">
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-4">
            <!-- Search Form -->
            <form action="{{ route('wallets.index') }}" method="GET">
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <button class="btn btn-danger btn-delete" data-url="{{route('wallets.destroy', $wallet)}}"><i class="fas fa-trash"></i></button>
                    </td>
                    <td>{{$wallet->id}}</td>
                    <td>{{ optional($wallet->user)->name }}</td> <!-- Display user name safely -->
