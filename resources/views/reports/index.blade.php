...
@section('content-header', 'Complaints Management')
    ...
    <div class="card-body">
        <div class="row mb-4">
            ...
            <div class="col-md-4 text-right">
                <form id="search-form" action="{{ route('reports.index') }}" method="GET">
            ...
            <table class="table table-bordered table-hover">
                <thead class="thead-dark">
                    <tr>
                        ...
                        <th>Chat User ID <i class="fas fa-sort"></i></th>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <button class="btn btn-danger btn-delete" data-url="{{route('reports.destroy', $report)}}"><i class="fas fa-trash"></i></button>
                        </td>
                        <td>{{$report->id}}</td> 
                        <td>{{ optional($report->user)->id }}</td> 
                        <td>{{ optional($report->user)->name }}</td> 
                        <td>{{ optional($report->chatUser)->id }}</td> 
