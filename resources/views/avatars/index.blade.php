...
@section('content-header', 'Avatar Management')
@section('content-actions')
    <a href="{{ route('avatars.create') }}" class="btn btn-success"><i class="fas fa-plus"></i> Add New Avatars</a>
@endsection
...
<div class="card">
    ...
    <div class="row mb-4">
        <div class="ml-auto">
        <form id="search-form" action="{{ route('avatars.index') }}" method="GET">
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                    <td>
                            <a href="{{ route('avatars.edit', $avatar) }}" class="btn btn-primary"><i class="fas fa-edit"></i></a>
                            <button class="btn btn-danger btn-delete" data-url="{{route('avatars.destroy', $avatar)}}"><i class="fas fa-trash"></i></button>
                        </td>
                        <td>{{$avatar->id}}</td>
                        <td>{{$avatar->gender}}</td>
                     
                        <td>
                            <a href="{{ asset('storage/app/public/avatars/' . $avatar->image) }}" data-lightbox="image-{{ $avatar->id }}">
                                <img class="customer-img img-thumbnail img-fluid" src="{{ asset('storage/app/public/avatars/' . $avatar->image) }}" alt="Image" style="max-width: 100px; max-height: 100px;">
                            </a>
                         </td>
                    </tr>
                    @endforeach
